...
【注：游戏设计话题属于艺术与媒体专业，游戏设计细节请参考 Ernest Adams 或 Tracy Fullerton 编写的教材】

游戏元素是设计师总结，并不是铁定规律，不同的游戏设计教材是有差别的（作为理工科生一般难以理解）。 比较公认的游戏设计元素包括：
...
游戏计算就是产生一个“合理”的 四元组（参与者，动作，游戏当前状态，游戏结果状态）序列。
