...
[Canvas Renderer](https://docs.unity3d.com/Manual/class-CanvasRenderer.html) 是所有 UI 元素的灵魂伴侣。按官方说法，尽管它没有暴露任何属性，但可以控制通过脚本独立控制该区域的 Rander 能力。
...
师兄实现背包系统的案例讲解：https://blog.kinpzz.com/2016/05/21/unity3d-ugui-Inventory/
...
![](images/drf/advanced.png) 门面模式的 Unity 设计
