...
如果你看过“微微一笑很倾城”，看到计算机系的肖奈大神凭着游戏创意和一组原画就征服了 **立志成为游戏工程师** 的学霸女神贝薇薇，从而也立志学习游戏。这显然和作者犯了类似的错误 - 不了解计算机学科和游戏，大概只有职业技术类学校的计算机专业才会把类似内容纳入教学体系。游戏在历史上就不是计算科学，只是计算机产业的发展使得 **视频游戏（Video Game）** 得到普及，并创造了无限想象的有趣的玩法。

游戏入门，你必须了解游戏学习的内容以及你个人的需求。下图从 **艺术** 和 **技术** 两个维度对游戏学习课程做了划分。所谓艺术就是利用语言、声音、文字、绘画、眼神、呼吸、肢体等表达形式，创造游戏场景或情境，使人通过感知（看、听、嗅、触）得到某种审美的满足。所谓技术，就是游戏生产的技能，使得游戏得以实现、质量得到保证。通过 **游戏艺术** 和 **计算机技术**，我们把游戏课程划分如图几种类型：
...
* 面向对象的游戏开发 作者:（美）戈德 著，陈为 等译 出版社:电子工业出版社出版 [豆瓣读书](https://book.douban.com/subject/1392493/)
...
本文的目标是最为优秀游戏软件工程师的入门的专业教材，且具有一定的趣味性。帮助读者从业余水平，变为专业游戏开发程序猿，因此本文内容是初中级教程。即本文使用 unity3d 作为开发环境，但不会过多讲述 unity3d 的操作。本文重点围绕游戏引擎结构，采用面向对象设计方法，通过若干案例讲述“设计模式”在游戏中的应用。
